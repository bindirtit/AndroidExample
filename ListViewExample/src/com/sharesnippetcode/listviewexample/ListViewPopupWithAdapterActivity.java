...
public class ListViewPopupWithAdapterActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_list_view_popup_with_adapter);
	...
	public void showPopUp() {
		...
		alertDialogStores = new AlertDialog.Builder(
				ListViewPopupWithAdapterActivity.this).setView(listViewItems)
				.setTitle("Stores").show();
